...
p <- ggplot(sales) + geom_point(aes(x = released, y = sales_million, color = artist)) + facet_wrap(.~country, nrow=3, scales = "free") + labs(x = "Released Date", y = "Sales in Million", title = "Time Trend of Sales (in million) in US, UK, and the world, by Artist", caption = "Meilin Zheng") + theme_bw()
p
```
